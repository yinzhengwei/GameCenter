package cn.com.gamecenter.ship.bg
...
import cn.com.gamecenter.ship.bg.Bar
import cn.com.gamecenter.ship.bg.DnBar
import cn.com.gamecenter.ship.bg.UpBar
import java.util.*
...
//        barsList.flatMap { listOf(it.up, it.down,it.up, it.down,it.up, it.down) }.forEach {
